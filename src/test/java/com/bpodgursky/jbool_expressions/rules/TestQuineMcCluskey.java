...
public class TestQuineMcCluskey extends JBoolTestCase {
  ...
  public void testFindMinterms() {
    ...
    List<Integer> minterms = QuineMcCluskey.findMinterms(0, vars, new HashMap<>(), expr, new RulesHelper.UnboundedCache<>(new ExprFactory.Default<>()));
  ...
  public void testAll() {
    ...
    Expression<String> simplified = QuineMcCluskey.toDNF(expr, new RulesHelper.UnboundedCache<>(new ExprFactory.Default<>()));
